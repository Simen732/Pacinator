...
class DQN:
    def __init__(self, params):
        ...
        # Updated to 24 channels for frame stacking (4 frames × 6 channels)
        self.x = tf.placeholder('float', [None, params['width'],params['height'], 24],name=self.network_name + '_x')
        ...
        self.terminals = tf.placeholder("float", [None], name=self.network_name + '_terminals')
                ...
                # Layer 1 (Convolutional) - Updated input channels to 24
        layer_name = 'conv1' ; size = 3 ; channels = 24 ; filters = 16 ; stride = 1
